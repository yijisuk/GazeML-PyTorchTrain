...
class UnityEyesDataset(torch.utils.data.IterableDataset):
    ...
    def preprocess_entry(self, entry):
        ...
        eyeball_radius = original_eyeball_radius * \
            scale_mat[0, 0]  # See: https://goo.gl/ZnXgDE
        ...
        recentre_mat[1, 2] = ih/2 - eye_middle[1] + \
            0.5 * oh / ow * eye_width * scale_inv
        ...
        original_gaze = gaze_util.vector_to_pitchyaw(
        ...
        iris_centre = np.asarray([
            iw_2 + original_eyeball_radius * -
            np.cos(original_gaze[0]) * np.sin(original_gaze[1]),
